...
**✅ LIVE ON TESTNET:** All contracts deployed at `ST12KRGRZ2N2Q5B8HKXHETGRD0JVF282TAAXNM1ZV`
...
- 🔄 Token swaps and volume
- 📈 TWAP oracle observations
- 🏭 Pool creation events

**For Builder Challenge Tracking:**

- ✅ Users generated by smart contracts
- ✅ Fees generated from swaps
- ✅ Active use of Hiro Chainhooks

📚 [View Chainhooks Documentation](chainhooks/README.md)
...
│   ├── core/
│   │   ├── pool-registry.clar       ✅ Deployed (contract-hash?)
│   │   ├── pool-template.clar       ✅ Deployed
│   │   ├── pool-factory.clar        ✅ Deployed
│   │   ├── router.clar              ✅ Deployed
│   │   └── twap-oracle.clar         ✅ Deployed (stacks-block-time)
│   └── tokens/
│       └── test-token.clar          ✅ Deployed
├── tests/
│   ├── unit/                        # Unit tests
│   └── onchain/                     # On-chain integration tests
...
│   ├── predicates/                  # Chainhook configurations
│   │   ├── pool-events.json
│   │   ├── swap-events.json
...
📚 [Full Chainhooks Documentation](chainhooks/README.md)
...
📄 [Full Deployment Details](TESTNET_DEPLOYMENT.md)
...
- **Endpoint:** `GET /api/stats` → `totalUsers`
- **Source:** All transaction senders

### ✅ Fees Generated

- **Tracked via:** Swap event monitoring
- **Endpoint:** `GET /api/stats` → `totalFees`
